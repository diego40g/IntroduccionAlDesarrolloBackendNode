...
exports.deleteProduct = exports.updateProductAndNotify = exports.partialUpdateProduct = exports.updateProduct = exports.createProduct = exports.getProductById = exports.getProducts = void 0;
...
const updateProductAndNotify = (req, res) => {
    ...
    if (index != -1) {
        ...
        //codigo enviar notificacion
        res.send({ data: products_1.products[index], message: `Email send to ${client}` });
    }
    else {
        res.status(404).send({});
    }
...
const deleteProduct = (req, res) => {
    ...
    const index = products_1.products.findIndex((item) => item.id === productId);
    if (index != -1) {
        const resultDelete = products_1.products.splice(index, 1);
        res.send({ data: resultDelete });
    }
    else {
        res.status(404).send({});
    }
