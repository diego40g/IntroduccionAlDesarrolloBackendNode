...
const usersController = __importStar(require("../../controller/v1/users-controller"));
const productsController = __importStar(require("../../controller/v1/products-controller"));
